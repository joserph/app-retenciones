  ...
  {{ Form::open(array('url' => 'reportes-ventas-create', 'class' => 'create_reporte_venta')) }} 
    ...
    <div class="row">     
      <div class="col-md-4">
        ...
        {{ Form::text('total_v', null, array('class' => 'form-control', 'placeholder' =>'Número de factura', 'id' => 'total_v1', 'onkeyup' => 'calcular(1)', 'autofocus', 'required')) }}
      </div>      
      <div class="col-md-4">
      ...
      <div class="col-md-4">
        ...
        {{ Form::text('exento', null, array('class' => 'form-control', 'placeholder' =>'Número nota de débito', 'id' => 'exento1', 'onkeyup' => 'calcular(1)', 'required')) }}
      </div>
      <div class="col-md-4">
